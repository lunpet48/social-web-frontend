...
const UserNotFound = () => {
  ...
  return (
    <div className='flex flex-col h-screen justify-center items-center gap-3'>
      ...
      <div className='text-gray-text text-3xl font-bold'>Người dùng không tồn tại</div>
      <div className='text-gray-text text-lg font-semibold flex flex-col items-center'>
        <p>Người dùng này không tồn tại trong hệ thống,</p>
        <p>đã chặn hoặc bị chặn bởi bạn hoặc đã bị xóa.</p>
      </div>
